...
def train(train_loader, epochs):
    ...
    # 网络放到GPU上
    net = network.MixConvNet().to(device)
    # 交叉熵损失函数
    loss_func = FocalLoss()
    # 初始化优化器
...
if __name__ == '__main__':
    ...
    # 只保存模型参数
    torch.save(net.state_dict(), 'cls_params/Trento_final.pth')
    ...
    Test_time = toc2 - tic2
    file_name = "cls_result/Trento_ours.txt"
    ...
    Utils.generate_png(
        total_iter, net, y, device, total_indices, 'cls_map/' + 'Trento_ours')
