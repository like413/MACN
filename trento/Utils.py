...
def list_to_colormap(x_list):
    ...
    for index, item in enumerate(x_list):
        if item == 0:
            y[index] = np.array([65, 85, 161]) / 255.
        if item == 1:
            y[index] = np.array([113, 197, 233]) / 255.
        if item == 2:
            y[index] = np.array([167, 205, 123]) / 255.
        if item == 3:
            y[index] = np.array([247, 212, 73]) / 255.
        if item == 4:
            y[index] = np.array([219, 70, 51]) / 255.
        if item == 5:
            y[index] = np.array([115, 31, 28]) / 255.
        if item == 6:
